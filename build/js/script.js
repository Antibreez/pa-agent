...
(function () {
  ...
  function checkForm() {
    var files = filesWrapper.querySelectorAll('.file-load.loaded');
    files.length > 0 && submit.hasAttribute('disabled') && submit.removeAttribute('disabled');
    files.length === 0 && !submit.hasAttribute('disabled') && submit.setAttribute('disabled', '');
  }
...
(function () {
  ...
  var onLinkClick = function onLinkClick(e) {
    ...
    if (target.classList.contains("checkbox-btn__label") || target.classList.contains("checkbox-btn__checkbox") || target.classList.contains("contract-info__verification") || target.classList.contains("payment-waiting__confirm-btn") || target.classList.contains("contract-services__delivery-confirm") || target.classList.contains("reports__download-btn") || $(target).parents(".reports__download-btn").length > 0) {
      e.preventDefault();
    }
  };
...
(function () {
  ...
  $(document).on("click", function (e) {
    ...
    if ($target.hasClass("reports__download-btn") || $target.parents(".reports__download-btn").length > 0 || $target.hasClass("reports__download-dropdown") || $target.parents(".reports__download-dropdown").length > 0) {
      return;
    } else {
      $dropdown.removeClass("shown");
    }
...
(function () {
  var $btn = $(".subscription-all__sell-service-btn");
  var $dropdown = $(".subscription-all__sell-service-dropdown");
  $btn.on("click", function () {
    $(this).toggleClass("opened");
  ...
  $(document).on("click", function (e) {
    ...
    if ($target.parents(".subscription-all__sell-service-dropdown").length > 0) {
      return;
    }
